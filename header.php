    ...
    <nav>
        ...
        <?php
            if (isset($_SESSION["useruid"])) {
                ...
                echo "<a href='profile.php' target='_blank'><button class='nav-button'>Profile</button></a>";
                ...
                echo "<a href='login.php' target='_blank'><button class='nav-button'>Log In</button></a>";
            }
        ?>
